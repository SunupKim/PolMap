...
# 프로젝트 루트 경로 (src/config/__init__.py 기준 2단계 상위)
...
# 시스템 프롬프트 로드
SYSTEM_PROMPT_PATH = PROMPTS_DIR / "system_normal.txt"
if SYSTEM_PROMPT_PATH.exists():
    with open(SYSTEM_PROMPT_PATH, "r", encoding="utf-8") as f:
        system_instruction_normal = f.read().strip()
else:
    system_instruction_normal = "You are a helpful assistant."
...
# SINGLE_TITLE_THRESHOLD = 0.18~
# SINGLE_CONTENT_THRESHOLD = 0.17~

# 챗 지피티 추천값은 다음과 같지만 내 경험으로는 title가 1~2 정도 높아야 한다 또한 SINGLE보다 GLOBAL이 높게 나옴에 유의하자.
# SINGLE_TITLE_THRESHOLD = 0.18 ~ 0.25
# SINGLE_CONTENT_THRESHOLD = 0.20 ~ 0.30
# GLOBAL_TITLE_THRESHOLD = 0.22 ~ 0.30
# GLOBAL_CONTENT_THRESHOLD = 0.25 ~ 0.35

# 0207 만족
SINGLE_TITLE_THRESHOLD = 0.18
SINGLE_CONTENT_THRESHOLD = 0.17
GLOBAL_TITLE_THRESHOLD = 0.20
GLOBAL_CONTENT_THRESHOLD = 0.19
######
...
# 파일 경로 지정
OUTPUT_ROOT = str(ARCHIVE_DIR)
CANONICAL_ARCHIVE_PATH = str(ARCHIVE_DIR / "aggregated" / "canonical_archive.csv")
